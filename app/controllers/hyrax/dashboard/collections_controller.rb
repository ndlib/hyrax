  ...
  module Dashboard
    ...
    class CollectionsController < Hyrax::My::CollectionsController
      ...
      def new
        ...
        collection_type_id = params[:collection_type_id].presence || Hyrax::CollectionType.find_or_create_default_collection_type.id
      ...
      def create
        ...
        # use the default collection type (provides backward compatibility with versions < Hyrax 2.1.0)
        @collection.collection_type_gid = params[:collection_type_gid].presence || Hyrax::CollectionType.find_or_create_default_collection_type.gid
