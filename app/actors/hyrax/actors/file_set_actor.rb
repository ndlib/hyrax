module Hyrax
  module Actors
    ...
    class FileSetActor
      ...
      def destroy
        unlink_from_work(file_set.parent)
        unlink_rendering(file_set.parent)
        file_set.destroy
      ...
      private
        ...
        def unlink_rendering(work)
          return unless work && work.rendering_ids.include?(file_set.id)
